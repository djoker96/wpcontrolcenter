...
let JobsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('jobs')];
    ...
    var JobsController = class {
        ...
        static {
            ...
            __esDecorate(this, null, _retry_decorators, { kind: "method", name: "retry", static: false, private: false, access: { has: obj => "retry" in obj, get: obj => obj.retry }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        jobsService = __runInitializers(this, _instanceExtraInitializers);
        constructor(jobsService) {
            this.jobsService = jobsService;
        }
        findAll() { return { data: this.jobsService.findAll() }; }
        findOne(id) { return this.jobsService.findOne(id); }
        retry(id) { return { id, status: 'QUEUED' }; }
        cancel(id) { return { id, status: 'CANCELED' }; }
    };
