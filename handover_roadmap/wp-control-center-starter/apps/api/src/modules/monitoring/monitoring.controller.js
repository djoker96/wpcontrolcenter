...
let MonitoringController = (() => {
    let _classDecorators = [(0, common_1.Controller)('monitoring')];
    ...
    let _uptimeChecks_decorators;
    var MonitoringController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _overview_decorators = [(0, common_1.Get)('overview')];
            _incidents_decorators = [(0, common_1.Get)('incidents')];
            _uptimeChecks_decorators = [(0, common_1.Get)('uptime-checks')];
            ...
            __esDecorate(this, null, _uptimeChecks_decorators, { kind: "method", name: "uptimeChecks", static: false, private: false, access: { has: obj => "uptimeChecks" in obj, get: obj => obj.uptimeChecks }, metadata: _metadata }, null, _instanceExtraInitializers);
