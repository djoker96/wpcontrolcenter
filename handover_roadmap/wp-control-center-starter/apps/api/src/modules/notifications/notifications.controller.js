...
let NotificationsController = (() => {
    ...
    var NotificationsController = class {
        ...
        static {
            ...
            _findAll_decorators = [(0, common_1.Get)('channels')];
            _create_decorators = [(0, common_1.Post)('channels')];
            _update_decorators = [(0, common_1.Patch)('channels/:id')];
            _remove_decorators = [(0, common_1.Delete)('channels/:id')];
        ...
        create(body) { return { id: 'notification_new', ...body }; }
