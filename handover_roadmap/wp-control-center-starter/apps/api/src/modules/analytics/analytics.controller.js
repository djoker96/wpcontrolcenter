...
let AnalyticsController = (() => {
    ...
    var AnalyticsController = class {
        ...
        static {
            ...
            _ga4_decorators = [(0, common_1.Get)('sites/:id/ga4')];
            _gsc_decorators = [(0, common_1.Get)('sites/:id/gsc')];
            ...
            __esDecorate(this, null, _ga4_decorators, { kind: "method", name: "ga4", static: false, private: false, access: { has: obj => "ga4" in obj, get: obj => obj.ga4 }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _gsc_decorators, { kind: "method", name: "gsc", static: false, private: false, access: { has: obj => "gsc" in obj, get: obj => obj.gsc }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        ga4(id) { return { siteId: id, source: 'GA4', data: [] }; }
        gsc(id) { return { siteId: id, source: 'GSC', data: [] }; }
    };
